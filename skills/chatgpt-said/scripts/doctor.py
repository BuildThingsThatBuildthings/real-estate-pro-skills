#!/usr/bin/env python3
"""chatgpt-said dependency doctor.
...
This skill is deliberately light: no network, no API keys, no media toolchain.
...
def main():
    d = Doc()
    print(f"chatgpt-said doctor — {OS}, python {platform.python_version()}\n")
    ...
    if d.required_missing:
        ...
        return 1
    print("Ready. Nothing here reaches a client until reconcile_gate.py exits 0.")
    return 0
