...
**If you cannot browse the web, or a fetch comes back as a summary instead of the full text:** tell me so in one sentence, then walk me through it one file at a time — give me link 1 above, tell me to open it in my browser, select everything on the page, and paste it back to you. Then link 2, and so on. The pages are plain text, so what I see is the whole file. Do not skip any of the five, and do not work from a summary.
